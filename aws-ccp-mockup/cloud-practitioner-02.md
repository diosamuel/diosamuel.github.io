...
- [Content Domain 1: Cloud Concepts](#content-domain-1-cloud-concepts)
- [Content Domain 2: Security and Compliance](#content-domain-2-security-and-compliance)
- [Content Domain 3: Cloud Technology and Services](#content-domain-3-cloud-technology-and-services)
- [Content Domain 4: Billing, Pricing, and Support](#content-domain-4-billing-pricing-and-support)
...
The following list contains AWS services and features that are in scope for the AWS Certified Cloud Practitioner (CLF-C02) exam. This list is non-exhaustive and is subject to change. AWS offerings appear in categories that align with the offerings' primary functions.
...
How useful was this exam guide? Let us know by taking our [survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=CloudPractitioner&course_id=CLF-C02&Q_Language=EN).
